...
namespace Masd.CSharpRefImpl.CSharpModel.Package1
{
    ...
    public static class AssociationInPackageDumper
    {
        static internal void Dump(AssistantDumper assistant, AssociationInPackage value, bool withSeparator = false)
        {
            ...
            assistant.AddType("Masd.CSharpRefImpl.CSharpModel.Package1.AssociationInPackage", true/*withSeparator*/);
            if (value == null)
            {
            ...
            assistant.AddPairSeparator();
            Masd.CSharpRefImpl.CSharpModel.PrimitiveBuiltinsDumper.Dump(assistant, value.Prop0, true/*withSeparator*/);
            assistant.AddKey("Prop1");
            assistant.AddPairSeparator();
            Masd.CSharpRefImpl.CSharpModel.ComplexBuiltinsDumper.Dump(assistant, value.Prop1, true/*withSeparator*/);
            assistant.AddKey("Prop2");
            assistant.AddPairSeparator();
            Masd.CSharpRefImpl.CSharpModel.Package1.Class1Dumper.Dump(assistant, value.Prop2);
