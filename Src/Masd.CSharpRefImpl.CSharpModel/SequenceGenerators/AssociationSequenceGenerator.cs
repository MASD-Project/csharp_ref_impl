...
namespace Masd.CSharpRefImpl.CSharpModel
{
    ...
    public static class AssociationSequenceGenerator
    {
        static internal void Populate(Association value, uint position)
        {
            ...
            value.Prop1 = Masd.CSharpRefImpl.CSharpModel.NoPropertiesSequenceGenerator.Create(position + 1);
            value.Prop2 = Masd.CSharpRefImpl.CSharpModel.ColourTypesSequenceGenerator.Create(position + 2);
        }
